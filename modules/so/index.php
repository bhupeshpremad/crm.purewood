...
// We also fetch the sell_order_number here
$stmt = $conn->prepare("SELECT id, po_number, client_name, prepared_by, order_date, delivery_date, created_at, updated_at, status, is_locked, sell_order_number
                        FROM po_main
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="soItemDetailsModalLabel">Sell Order Item Details</h5>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.success && data.items.length > 0) {
                        ...
                        tbody.append('<tr><td colspan="8" class="text-center">No items found for this Sell Order.</td></tr>');
                    } else {
                        tbody.append(`<tr><td colspan="8" class="text-center text-danger">Error: ${data.message || 'Failed to load items.'}</td></tr>`);
                ...
                error: function(xhr, status, error) {
                    ...
                    $('#soItemDetailsTable tbody').empty().append(`<tr><td colspan="8" class="text-center text-danger">Network error or failed to parse response: ${error}</td></tr>`);
