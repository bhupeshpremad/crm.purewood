    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800"><?php echo $editMode ? 'Edit' : 'Add'; ?> Quotation</h1>
                <?php if ($editMode): ?>
                    <button class="btn btn-success text-capitalize activeStatusBtn" style="padding: 0.075rem;" data-quotation-id="<?php echo $quotation['id']; ?>" title="Approved">Approved</button>
                <?php endif; ?>
            </div>
            ...
            <form id="quotationForm" class="p-4" enctype="multipart/form-data">
                <fieldset class="mb-4">
                    <legend>Quotation Information</legend>
                    <div class="row mb-3">
                        <div class="col-sm-6 col-md-3 mb-3">
                            <label for="lead_number" class="form-label">Lead Number</label>
                            <select class="form-control rounded-0" id="lead_number" name="lead_id" required <?php echo $disableLeadDropdown ? 'disabled' : ''; ?>>
                        ...
                        <div class="col-sm-6 col-md-3 mb-3">
                            ...
                            <input type="date" class="form-control rounded-0" id="quotation_date" name="quotation_date" value="<?php echo $editMode && $quotation ? htmlspecialchars($quotation['quotation_date']) : date('Y-m-d'); ?>" required>
                        </div>
                        <div class="col-sm-6 col-md-3 mb-3">
                            <label for="quotation_number" class="form-label">Quotation Number</label>
                            <input type="text" class="form-control rounded-0" id="quotation_number" name="quotation_number" readonly value="<?php echo $editMode && $quotation ? htmlspecialchars($quotation['quotation_number']) : ''; ?>">
                        </div>
                        <div class="col-sm-6 col-md-3 mb-3">
                            <label for="customer_name" class="form-label">Customer Name</label>
                            <input type="text" class="form-control rounded-0" id="customer_name" name="customer_name" readonly value="<?php echo $editMode && $quotation ? htmlspecialchars($quotation['customer_name']) : ''; ?>">
                        </div>
                        <div class="col-sm-6 col-md-3 mb-3">
                            <label for="customer_email" class="form-label">Customer Email</label>
                            <input type="email" class="form-control rounded-0" id="customer_email" name="customer_email" readonly value="<?php echo $editMode && $quotation ? htmlspecialchars($quotation['customer_email']) : ''; ?>">
                        </div>
                        <div class="col-sm-6 col-md-3 mb-3">
                            <label for="customer_phone" class="form-label">Customer Phone</label>
                            <input type="tel" class="form-control rounded-0" id="customer_phone" name="customer_phone" readonly value="<?php echo $editMode && $quotation ? htmlspecialchars($quotation['customer_phone']) : ''; ?>">
                        </div>
                        <div class="col-sm-6 col-md-3 mb-3">
                            <label for="delivery_term" class="form-label">Payment Terms</label>
                            <input type="text" class="form-control rounded-0" id="delivery_term" name="delivery_term" value="<?php echo $editMode && $quotation ? htmlspecialchars($quotation['delivery_term']) : ''; ?>">
                        </div>
                        <div class="col-sm-6 col-md-3 mb-3">
                            <label for="terms_of_delivery" class="form-label">Terms of Delivery</label>
                            <input type="text" class="form-control rounded-0" id="terms_of_delivery" name="terms_of_delivery" value="<?php echo $editMode && $quotation ? htmlspecialchars($quotation['terms_of_delivery']) : ''; ?>">
                        </div>
                    </div>
                </fieldset>

                <div>
                    <button type="button" class="btn bg-gradient-primary text-white rounded-0 mb-3" data-toggle="modal" data-target="#addProductModal">Add Product</button>
                    <div class="table-responsive">
                        <table id="productTable" class="table table-bordered">
                            <thead class="bg-gradient-primary text-white">
                                <tr>
                                    <th class="bg-gradient-primary text-white">Sno</th>
                                    <th class="bg-gradient-primary text-white">Product Image</th>
                                    <th class="bg-gradient-primary text-white">Item Name</th>
                                    <th class="bg-gradient-primary text-white">Item Code</th>
                                    <th class="bg-gradient-primary text-white">Assembly</th>
                                    <th colspan="3" class="text-center bg-gradient-primary text-white">Item Dimension (cms)</th>
                                    <th colspan="3" class="text-center bg-gradient-primary text-white">Box Dimension (cms)</th>
                                    <th class="bg-gradient-primary text-white">CBM</th>
                                    <th class="bg-gradient-primary text-white">Wood/Marble Type</th>
                                    <th class="bg-gradient-primary text-white">No. of Packet</th>
                                    <th class="bg-gradient-primary text-white">Iron Gauge</th>
                                    <th class="bg-gradient-primary text-white">MDF Finish</th>
                                    <th class="bg-gradient-primary text-white">MOQ</th>
                                    <th class="bg-gradient-primary text-white">Price USD</th>
                                    <th class="bg-gradient-primary text-white">Total USD</th>
                                    <th class="bg-gradient-primary text-white">Comments</th>
                                    <th class="bg-gradient-primary text-white">Action</th>
                                </tr>
                                <tr>
                                    <th></th><th></th><th></th><th></th><th></th>
                                    <th class="bg-gradient-primary text-white small">H</th><th class="bg-gradient-primary text-white small">W</th><th class="bg-gradient-primary text-white small">D</th>
                                    <th class="bg-gradient-primary text-white small">H</th><th class="bg-gradient-primary text-white small">W</th><th class="bg-gradient-primary text-white small">D</th>
                                        ...
                                        <tr>
                                            ...
                                            <td data-image-name="<?php echo htmlspecialchars($product['product_image_name']); ?>">
                                                <?php if (!empty($product['product_image_name'])) : ?>
                                                    <img src="<?php echo '/php_erp/purewood/assets/images/upload/quotation/' . htmlspecialchars($product['product_image_name']); ?>" alt="Product Image" style="max-width: 80px; max-height: 80px;">
                                                <?php else : ?>
                            ...
                            <tfoot>
                                <tr>
                                    <th colspan="18" class="text-end">Total Amount</th>
                ...
                <button type="submit" class="btn bg-gradient-primary text-white rounded-0 mt-4"><?php echo $editMode ? 'Update Quotation' : 'Submit Quotation'; ?></button>
                <?php if ($editMode): ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        <label for="modal_box_h" class="form-label">Box H (cms)</label>
                        <input type="number" class="form-control rounded-0" id="modal_box_h" step="0.01">
                    </div>
                    <div class="col-md-3">
                        <label for="modal_box_w" class="form-label">Box W (cms)</label>
                        <input type="number" class="form-control rounded-0" id="modal_box_w" step="0.01">
                    </div>
                    <div class="col-md-3">
                        <label for="modal_box_d" class="form-label">Box D (cms)</label>
                        <input type="number" class="form-control rounded-0" id="modal_box_d" step="0.01">
                    </div>
                <div class="col-md-3">
