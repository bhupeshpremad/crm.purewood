<?php
// Include config to get BASE_URL, ROOT_DIR_PATH
include_once __DIR__ . '/../config/config.php';



// Include header (jo config.php ko already include karta hai)
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?php
        // Include common dynamic sidebar
     ...
     <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php
                include_once ROOT_DIR_PATH . 'include/inc/footer-top.php';
            ?>
        </div>
